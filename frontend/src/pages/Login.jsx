...
function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden" style={{ background: isNight ? "#09090b" : "#fdf6ee", transition: "background 0.5s ease" }}>
      <img src="/login.png" alt="Background" className="absolute inset-0 w-full h-full object-cover opacity-90" />
      ...
      <div className="max-w-[95%] xl:max-w-[1400px] mx-auto grid md:grid-cols-2 gap-12 items-center relative z-10 w-full px-4">
        <div className="slide-left hidden md:block pl-4 lg:pl-10">
          ...
          <h1 className="text-5xl md:text-6xl font-black leading-tight mb-4 text-white drop-shadow-md" style={{ fontFamily: "'Playfair Display', serif" }}>
            Rent Anything.<br />
            <span className="text-transparent bg-clip-text bg-white drop-shadow-sm">Earn Everything.</span>
          </h1>
        ...
        <div className="slide-right flex justify-end pr-4 lg:pr-10">
          <div
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="flex flex-col" style={{ transform: "translateZ(10px)" }}>
              ...
              <button type="submit" disabled={loading} className="bg-[#0f4039] text-white font-bold py-3 rounded-xl hover:bg-[#0b2f29] active:scale-95 transition cursor-pointer disabled:cursor-not-allowed shadow-md">
