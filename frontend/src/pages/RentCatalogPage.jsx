  ...
  return (
    <div className="min-h-screen font-sans overflow-x-hidden bg-[#F4E8D6] text-slate-900 transition-colors duration-500 py-6 px-4 md:px-8">
      ...
      <div className="max-w-7xl mx-auto mb-6 flex justify-between items-center flex-wrap gap-4 border-b pb-4 border-slate-100 dark:border-slate-800">
        ...
        <div>
          <h1 className="text-xl md:text-3xl font-bold text-right text-[#1F3123]" style={{ fontFamily: "'Playfair Display', serif" }}>🛒 Peer-to-Peer Rental Hub</h1>
          <p className="text-[10px] text-slate-500 text-right mt-0.5 font-semibold">Explore high-quality shared equipment near you</p>
        </div>
      </div>
          ...
          />
            ...
            <div className="mb-5">
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-xs font-bold text-[#204138]">₹{maxPrice}/day</span>
              </div>
              <input 
                type="range" 
                min={100} 
            ...
            <div className="mb-6">
              <div className="flex justify-between items-center mb-2">
                <label className="text-xs font-black uppercase text-slate-500">Distance Radius</label>
                <span className="text-xs font-bold text-[#204138]">{maxDistance} km</span>
              </div>
              <input 
                type="range" 
                min={1} 
        ...
        <div className="lg:col-span-9">
          {filteredProducts.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-20 rounded-[16px] border border-[#EADEC9] bg-white shadow-sm">
              ...
              <p className="text-sm text-slate-500 mt-1 max-w-md text-center">Try resetting your keyword search or expanding the pricing and distance radius to see more results.</p>
              <button 
                onClick={() => { setSearch(""); setSelectedCategory("All"); setMaxPrice(10000); setMaxDistance(5); }}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredProducts.map(p => (
                <div 
                  ...
                  className="group relative hover:-translate-y-1 transition-all duration-300 cursor-pointer overflow-hidden rounded-[12px] bg-white card-border-motion"
                >
                  ...
                  <div className="p-4 flex flex-col gap-1.5 flex-grow bg-white">
                    ...
                    <div className="flex items-baseline gap-1 mb-1">
                      <span className="text-[#183028] font-black text-xl">₹{p.rentalPrice}</span>
                    ...
                    <div className="flex flex-col gap-1.5 mb-3">
                      <p className="text-[11px] text-slate-700 font-medium flex items-center gap-1.5">
                        Security Deposit: <span className="font-bold">₹{p.securityDeposit || "0"}</span>
                      </p>
